...
export const BACKGROUNDS = [
  ...
  { key: 'mist', label: '안개 (새벽 묵상)', tier: 'paid', categories: ['묵상'], animated: true,
    image: { path: '/pptx-bg-mist.gif', text: 'FFFFFF', previewColor: '#141B28', fallback: '141B28', overlay: 'rgba(0,0,0,0.5)' } },
  ...
  { key: 'crosslight', label: '십자가빛 (역광)', tier: 'paid', categories: ['십자가', '빛'], animated: true,
    image: { path: '/pptx-bg-crosslight.gif', text: 'FFFFFF', previewColor: '#0C0908', fallback: '0C0908', overlay: 'rgba(0,0,0,0.5)' } },
  ...
  { key: 'flowers', label: '들꽃 (가을 역광)', tier: 'paid', categories: ['자연'],
    image: { path: '/pptx-bg-flowers.jpg', text: 'FFFFFF', previewColor: '#B89060', overlay: 'rgba(0,0,0,0.5)' } },
  ...
  { key: 'ripple', label: '잔물결', tier: 'paid', categories: ['자연', '묵상'], animated: true,
    image: { path: '/pptx-bg-ripple.gif', text: 'FFFFFF', previewColor: '#0A1420', fallback: '0A1420', overlay: 'rgba(0,0,0,0.5)' } },
  ...
  { key: 'tomb', label: '빈무덤', tier: 'paid', categories: ['절기', '절기:부활', '십자가'],
    image: { path: '/pptx-bg-tomb.jpg', text: 'FFFFFF', previewColor: '#15120E', fallback: '15120E', overlay: 'rgba(0,0,0,0.5)' } },
  ...
  { key: 'cavelight', label: '동굴 속 빛', tier: 'paid', categories: ['절기', '절기:부활', '빛'],
    image: { path: '/pptx-bg-cavelight.jpg', text: 'FFFFFF', previewColor: '#494738', fallback: '494738', overlay: 'rgba(0,0,0,0.5)' } },
  ...
  { key: 'crossdusk', label: '흐린 하늘의 십자가', tier: 'paid', categories: ['절기', '절기:사순', '십자가'],
    image: { path: '/pptx-bg-crossdusk.jpg', text: 'FFFFFF', previewColor: '#65554A', fallback: '65554A', overlay: 'rgba(0,0,0,0.5)' } },
  ...
  { key: 'forestpath', label: '숲길의 햇살', tier: 'paid', categories: ['자연', '빛'],
    image: { path: '/pptx-bg-forestpath.jpg', text: 'FFFFFF', previewColor: '#3D4A4D', fallback: '3D4A4D', overlay: 'rgba(0,0,0,0.5)' } },
  ...
  { key: 'waterglow', label: '반짝이는 윤슬', tier: 'paid', categories: ['자연', '묵상'], animated: true,
    image: { path: '/pptx-bg-waterglow.gif', text: 'FFFFFF', previewColor: '#35484A', fallback: '35484A', overlay: 'rgba(0,0,0,0.5)' } },
  ...
  { key: 'deepwater', label: '고요한 수면', tier: 'paid', categories: ['자연', '묵상'], animated: true,
    image: { path: '/pptx-bg-deepwater.gif', text: 'FFFFFF', previewColor: '#64493C', fallback: '64493C', overlay: 'rgba(0,0,0,0.5)' } },
  ...
  { key: 'duskripple', label: '노을빛 잔물결', tier: 'paid', categories: ['자연', '묵상'], animated: true,
    image: { path: '/pptx-bg-duskripple.gif', text: 'FFFFFF', previewColor: '#593C16', fallback: '593C16', overlay: 'rgba(0,0,0,0.5)' } },
  ...
  { key: 'skyflow', label: '구름 흐르는 하늘', tier: 'paid', categories: ['자연', '빛'], animated: true,
    image: { path: '/pptx-bg-skyflow.gif', text: 'FFFFFF', previewColor: '#4D5E75', fallback: '4D5E75', overlay: 'rgba(0,0,0,0.5)' } },
  ...
  { key: 'wheatwind', label: '바람에 일렁이는 밀밭', tier: 'paid', categories: ['자연', '절기:추수감사'], animated: true,
    image: { path: '/pptx-bg-wheatwind.gif', text: 'FFFFFF', previewColor: '#4A4935', fallback: '4A4935', overlay: 'rgba(0,0,0,0.5)' } },
