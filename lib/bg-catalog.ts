...
export const BACKGROUNDS = [
  ...
  { key: 'easter2', label: '부활 아침', tier: 'paid', categories: ['절기', '절기:부활', '빛'],
    image: { path: '/pptx-bg-easter2.jpg', text: '1F1B16', previewColor: '#A69357', fallback: 'A69357', overlay: 'rgba(255,255,255,0.5)' } },
  ...
  { key: 'sunmaru', label: '산마루 해돋이', tier: 'paid', categories: ['자연', '빛'],
    image: { path: '/pptx-bg-sunmaru.jpg', text: '1F1B16', previewColor: '#767570', fallback: '767570', overlay: 'rgba(255,255,255,0.6)' } },
  { key: 'lily', label: '부활절 백합', tier: 'paid', categories: ['절기', '절기:부활', '자연'],
    image: { path: '/pptx-bg-lily.jpg', text: '1F1B16', previewColor: '#797630', fallback: '797630', overlay: 'rgba(255,255,255,0.6)' } },
  { key: 'cavelight', label: '동굴 속 빛', tier: 'paid', categories: ['절기', '절기:부활', '빛'],
    image: { path: '/pptx-bg-cavelight.jpg', text: '1F1B16', previewColor: '#494738', fallback: '494738', overlay: 'rgba(255,255,255,0.65)' } },
  { key: 'cross2', label: '노을 진 십자가', tier: 'paid', categories: ['절기', '절기:사순', '십자가'],
    image: { path: '/pptx-bg-cross2.jpg', text: '1F1B16', previewColor: '#E6B95A', fallback: 'E6B95A', overlay: 'rgba(255,255,255,0.5)' } },
  ...
  { key: 'threecross', label: '갈보리 세 십자가', tier: 'paid', categories: ['절기', '절기:사순', '십자가'],
    image: { path: '/pptx-bg-threecross.jpg', text: '1F1B16', previewColor: '#6C6D75', fallback: '6C6D75', overlay: 'rgba(255,255,255,0.6)' } },
  ...
  { key: 'purplesky', label: '보랏빛 저녁 하늘', tier: 'paid', categories: ['빛', '묵상'],
    image: { path: '/pptx-bg-purplesky.jpg', text: '1F1B16', previewColor: '#6E546D', fallback: '6E546D', overlay: 'rgba(255,255,255,0.65)' } },
  { key: 'crossdusk', label: '흐린 하늘의 십자가', tier: 'paid', categories: ['절기', '절기:사순', '십자가'],
    image: { path: '/pptx-bg-crossdusk.jpg', text: '1F1B16', previewColor: '#65554A', fallback: '65554A', overlay: 'rgba(255,255,255,0.65)' } },
  ...
  { key: 'ricepaddy', label: '계단식 논', tier: 'paid', categories: ['절기', '절기:추수감사', '자연'],
    image: { path: '/pptx-bg-ricepaddy.jpg', text: '1F1B16', previewColor: '#857908', fallback: '857908', overlay: 'rgba(255,255,255,0.6)' } },
  ...
  { key: 'cloudbreak', label: '구름을 뚫는 햇살', tier: 'paid', categories: ['빛', '자연'],
    image: { path: '/pptx-bg-cloudbreak.jpg', text: '1F1B16', previewColor: '#636865', fallback: '636865', overlay: 'rgba(255,255,255,0.65)' } },
  { key: 'forestpath', label: '숲길의 햇살', tier: 'paid', categories: ['자연', '빛'],
    image: { path: '/pptx-bg-forestpath.jpg', text: '1F1B16', previewColor: '#3D4A4D', fallback: '3D4A4D', overlay: 'rgba(255,255,255,0.65)' } },
  { key: 'bluesea', label: '쪽빛 바다', tier: 'paid', categories: ['자연', '묵상'],
    image: { path: '/pptx-bg-bluesea.jpg', text: '1F1B16', previewColor: '#7EA3BB', fallback: '7EA3BB', overlay: 'rgba(255,255,255,0.5)' } },
  ...
  { key: 'skyfield', label: '하늘과 들판', tier: 'paid', categories: ['자연'],
    image: { path: '/pptx-bg-skyfield.jpg', text: '1F1B16', previewColor: '#70705E', fallback: '70705E', overlay: 'rgba(255,255,255,0.6)' } },
  { key: 'meadowdusk', label: '들꽃밭의 노을', tier: 'paid', categories: ['자연', '빛'],
    image: { path: '/pptx-bg-meadowdusk.jpg', text: '1F1B16', previewColor: '#6A6048', fallback: '6A6048', overlay: 'rgba(255,255,255,0.65)' } },
  { key: 'seadawn', label: '여명의 바다', tier: 'paid', categories: ['자연', '묵상'],
    image: { path: '/pptx-bg-seadawn.jpg', text: '1F1B16', previewColor: '#626D7E', fallback: '626D7E', overlay: 'rgba(255,255,255,0.65)' } },
  { key: 'oceandusk', label: '노을빛 바다', tier: 'paid', categories: ['자연', '빛'],
    image: { path: '/pptx-bg-oceandusk.jpg', text: '1F1B16', previewColor: '#946D43', fallback: '946D43', overlay: 'rgba(255,255,255,0.6)' } },
  { key: 'lakemtn', label: '호수와 산', tier: 'paid', categories: ['자연', '묵상'],
    image: { path: '/pptx-bg-lakemtn.jpg', text: '1F1B16', previewColor: '#426B84', fallback: '426B84', overlay: 'rgba(255,255,255,0.65)' } },
  { key: 'doves', label: '평화의 비둘기', tier: 'paid', categories: ['빛', '묵상'],
    image: { path: '/pptx-bg-doves.jpg', text: '1F1B16', previewColor: '#98BEDD', fallback: '98BEDD', overlay: 'rgba(255,255,255,0.5)' } },
  ...
  { key: 'palms', label: '종려나무', tier: 'paid', categories: ['절기', '절기:종려', '자연'],
    image: { path: '/pptx-bg-palms.jpg', text: '1F1B16', previewColor: '#8A9292', fallback: '8A9292', overlay: 'rgba(255,255,255,0.5)' } },
  { key: 'altar', label: '촛불 켜진 제대', tier: 'paid', categories: ['예배', '묵상'],
    image: { path: '/pptx-bg-altar.jpg', text: '1F1B16', previewColor: '#572605', fallback: '572605', overlay: 'rgba(255,255,255,0.65)' } },
  { key: 'churchlight2', label: '예배당의 빛', tier: 'paid', categories: ['예배', '묵상'],
    image: { path: '/pptx-bg-churchlight2.jpg', text: '1F1B16', previewColor: '#94837E', fallback: '94837E', overlay: 'rgba(255,255,255,0.55)' } },
  ...
  { key: 'glowdust', label: '은은한 빛 가루', tier: 'paid', categories: ['빛', '묵상'], animated: true,
  ...
  { key: 'snowparticle', label: '떠다니는 빛 입자', tier: 'paid', categories: ['빛', '묵상'], animated: true,
  ...
  { key: 'golddust', label: '금빛 가루', tier: 'paid', categories: ['빛'], animated: true,
    image: { path: '/pptx-bg-golddust.gif', text: 'FFFFFF', previewColor: '#701703', fallback: '701703' } },
  { key: 'bokehlights', label: '은은한 빛망울', tier: 'paid', categories: ['빛', '묵상'], animated: true,
  ...
  { key: 'ripples3', label: '수면 위 잔물결', tier: 'paid', categories: ['자연', '묵상'], animated: true,
    image: { path: '/pptx-bg-ripples3.gif', text: 'FFFFFF', previewColor: '#918568', fallback: '918568' } },
  { key: 'seawave', label: '잔잔한 바다 물결', tier: 'paid', categories: ['자연', '묵상'], animated: true,
    image: { path: '/pptx-bg-seawave.gif', text: 'FFFFFF', previewColor: '#6693B0', fallback: '6693B0' } },
  ...
  { key: 'duskripple', label: '노을빛 잔물결', tier: 'paid', categories: ['자연', '묵상'], animated: true,
    image: { path: '/pptx-bg-duskripple.gif', text: 'FFFFFF', previewColor: '#593C16', fallback: '593C16' } },
  { key: 'cloudflow', label: '흐르는 구름', tier: 'paid', categories: ['자연', '빛'], animated: true,
    image: { path: '/pptx-bg-cloudflow.gif', text: 'FFFFFF', previewColor: '#7E8289', fallback: '7E8289' } },
  ...
  { key: 'wheatwind', label: '바람에 일렁이는 밀밭', tier: 'paid', categories: ['자연', '절기:추수감사'], animated: true,
    image: { path: '/pptx-bg-wheatwind.gif', text: 'FFFFFF', previewColor: '#4A4935', fallback: '4A4935' } },
