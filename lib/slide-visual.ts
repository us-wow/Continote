...
export const THEME_OVERLAY: Partial<Record<PptTheme, string>> = {
  ...
  // 어둡게 잡았던 절기 배경도 흰 스크림 적용(투명 처리 통일·글자 가독성).
  christmas: 'rgba(255,255,255,0.6)',
  lent: 'rgba(255,255,255,0.55)',
  tomb: 'rgba(255,255,255,0.62)',
  starnight: 'rgba(255,255,255,0.62)',
  nativity: 'rgba(255,255,255,0.62)',
  stormlight: 'rgba(255,255,255,0.55)',
};
