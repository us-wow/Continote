    ...
    >
      ...
      >
        ...
        <Section title="콘티노트는 이렇게 움직여요">
          악보 사진을 올리면 → AI가 가사를 뽑고 → 가사를 묶음으로 나눠 → 묶음을 눌러 콘티를
          만들고 → 예배용 PPT로 내려받아요. 화면은 위에서 아래로 <b>1 · 2 · 3 · 4</b> 순서예요.
        ...
        <Section title="3단계 · 콘티 편집">
          <List
            items={[
              <>2단계에서 칩을 누르면 여기에 가사가 쌓여요. 직접 입력해도 돼요.</>,
              <><b>가사 붙여넣기</b> — 이미 가진 가사를 통째로 붙여넣으면 <b>빈 줄 기준</b>으로 슬라이드가 자동으로 나뉘어요. (악보 없이 가사만 있어도 바로 PPT를 만들 수 있어요.)</>,
              <><b>빈 줄(엔터 두 번) = 슬라이드 나눔.</b> 빈 줄을 지우면 두 슬라이드가 다시 합쳐져요.</>,
              <>한 슬라이드 안에서는 줄바꿈(엔터 한 번)만 하면 돼요.</>,
              <>줄 맨 앞에 <b># </b>를 붙이면 제목 슬라이드, <b>&gt; </b>를 붙이면 메모 슬라이드(광고·기도제목 등)가 돼요.</>,
              <>슬라이드 번호 옆 <b>↑↓</b>로 순서를 옮기고, 한 슬라이드만 지울 수 있어요.</>,
              <>한 슬라이드가 4줄을 넘으면 빨간 표시가 떠요. 글씨 크기는 자동으로 줄어드니 너무 걱정 안 해도 돼요.</>,
              <>슬라이드 없이 글만 필요하면 <b>클립보드 복사 · TXT · DOCX</b>로 내보낼 수 있어요.</>,
            ]}
          />
        </Section>

        <Section title="4단계 · 배경 고르고 PPT 만들기">
          <List
            items={[
              <><b>무료 배경 6종</b> — 단색(검정·흰색·종이)과 실사(십자가·성경책·초원)는 누구나 써요.</>,
              <><b>배경 검색</b> — 배경이 수십 종이라 이름은 숨겨두고 검색으로 찾아요. 검색창에 <b>‘부활·사순·성탄·추수감사·종려·바다·십자가·빛’</b>처럼 치면 어울리는 배경이 떠요.</>,
              <><b>글꼴</b>(5종, 나눔고딕 추천)과 <b>세로 정렬</b>(위·가운데·아래)을 골라요. 고르면 미리보기와 PPT에 바로 반영돼요. (가사가 없어도 <b>‘배경 미리보기’</b>에서 미리 맞춰볼 수 있어요.)</>,
              <><b>전체 미리보기</b>로 모든 슬라이드를 한눈에 확인하고, <b>PPT 다운로드</b>로 .pptx를 만들어요.</>,
